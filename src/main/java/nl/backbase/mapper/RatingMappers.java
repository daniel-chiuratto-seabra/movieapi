...
public class RatingMappers {
     ...
     * {@link RatingEntity#setSource(String)} method, and the {@link MovieEntity} instance to set in the
     * {@link RatingEntity#setMovieEntity(MovieEntity)} method. Basically those 2 settings are setting who is rating
     ...
     * @param movieEntity {@link MovieEntity} to set the Movie which the corresponding {@link RatingEntity} is related with
     *
     ...
     * @since 04/08/2022
     */
    public RatingEntity ratingRequestDTORatingEntity(final RatingRequestDTO ratingRequestDTO, final Authentication authentication, final MovieEntity movieEntity) {
        if (ratingRequestDTO == null || authentication == null || movieEntity == null) { return null; }
     ...
     * {@link MovieMappers#movieEntityToBestPictureMovieDTO(MovieEntity)} parser method
     *
